        ...
        children: [
          Expanded(
            child: ListView(
              padding: EdgeInsets.all(16),
              children: [
                RoutineActionCard(title: '☕ Morning coffee', time: '7:30 AM', category: 'Morning'),
                RoutineActionCard(title: '📧 Check email', time: '8:00 AM', category: 'Morning'),
                RoutineActionCard(title: '🏃 Exercise routine', time: '6:30 AM', category: 'Morning'),
                RoutineActionCard(title: '🍽️ Lunch break', time: '12:00 PM', category: 'Afternoon'),
                RoutineActionCard(title: '🚶 Evening walk', time: '6:00 PM', category: 'Evening'),
                RoutineActionCard(title: '📱 Plan tomorrow', time: '10:00 PM', category: 'Evening'),
              ],
            ),
          ),
          Padding(
...
class RoutineTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isCasualTemplate) {
      displayActions = casualTemplateActions;
      headerText = 'The Casual - Today';
    } else if (routineActions != null && routineActions!.isNotEmpty) {
      displayActions = List.from(routineActions!);
      // Sort by time
          ...
          child: displayActions.isEmpty 
            ...
            : ListView(
                ...
                children: displayActions.map((action) => 
                  RoutineActionCard(
                    title: action['name'],
                    time: (action['time'] as TimeOfDay).format(context),
                    category: action['category'],
                  )
                ).toList(),
              ),
...
class RoutineActionCard extends StatelessWidget {
  ...
  RoutineActionCard({required this.title, required this.time, required this.category});
